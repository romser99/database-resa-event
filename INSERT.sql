...
INSERT INTO LIEU (nom, pays, adresse, region, alias)VALUES 
...
('exposition Victor Hugo',' ',(select id from type where nom = 'musee Louvre'), (select id from salle where nom = 'Salle Louis')),
('concert Shakira',' ',(select id from type where nom = 'musee Orsay'), (select id from salle where nom = 'Salle Cleopatre')),
('concert Rihanna',' ',(select id from type where nom = 'musee Orsay'), (select id from salle where nom = 'Salle Musique')),
('exposition art',' ',(select id from type where nom = 'musee Louvre'), (select id from salle where nom = 'Salle Joconde')),
('exposition plastique',' ',(select id from type where nom = 'musee Orsay'), (select id from salle where nom = 'Salle Marion')),
('exposition Channel', ' ',(select id from type where nom = 'musee Orsay'), (select id from salle where nom = 'Salle Pyramide')),
('ConcertHalsey Jour1', ' ',(SELECT id from type WHERE nom = 'Concert Pop'), (SELECT id from lieu WHERE nom = 'Accor Arena')),
('ConcertHalsey Jour2', ' ',(SELECT id from type WHERE nom = 'Concert Pop'), (SELECT id from lieu WHERE nom = 'Accor Arena')),
('Concert Raye', ' ',(SELECT id from type WHERE nom = 'Concert Rap'), (SELECT id from lieu WHERE nom = 'Paris La Defense Arena')),
...
INSERT INTO AGENDAS (date_debut, date_fin, horaire_debut, horaire_fin, id_evenement)VALUES
...
INSERT INTO personne (nom, prenom, mail, mdp, telephone, CREATION)VALUES 
